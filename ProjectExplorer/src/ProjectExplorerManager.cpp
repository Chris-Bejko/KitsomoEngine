...
ProjectExplorerManager &ProjectExplorerManager::get()
{
    static ProjectExplorerManager instance;
    return instance;
}

void ProjectExplorerManager::SetDirectory(const std::filesystem::path &newDirectory)
{
    directory = newDirectory;
}

const std::filesystem::path & ProjectExplorerManager::GetDirectory() const
{
    return directory;
}

std::vector<std::filesystem::directory_entry> ProjectExplorerManager::GetEntries() const
{
...
FileType *
ProjectExplorerManager::GetFileType(const std::filesystem::path &path)
{
