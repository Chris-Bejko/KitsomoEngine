...
public:
    ...
    bool RegisterExternal(const std::string &name, bool allowsMultiple, ComponentAddDefaultFn addDefault, ComponentApplySerializedFn applySerialized, bool isProjectComponent)
    {
        if (name.empty() || addDefault == nullptr || applySerialized == nullptr)
        {
            return false;
        }
        ...
        descriptor.applySerialized = [applySerialized](Entity *entity, ReadableSerializableVariableMap fields, std::string guid)
        {
            applySerialized(entity, fields, guid.c_str());
        };
...
private:
    ...
    static bool HasRequiredTypes(Entity *entity)
    {
        ...
        {
            return HasRequiredTypesImpl<T>(entity, std::make_index_sequence<std::tuple_size_v<Required>>{});
        }
    }
    ...
    static bool HasRequiredTypesImpl(Entity *entity, std::index_sequence<I...>)
    {
        ...
        return (entity->HasComponentOfType<std::tuple_element_t<I, Required>>() && ...);
    }
